...
public class SignalHandleServiceTest {
    ...
    void testSignalHandlerServiceWithCorrectSignalClass() {
        String actualResponse = signalHandlerService.invokeTradeAlgorithm(AppConstants.SIGNAL_THREE);
    ...
    void testSignalHandlerServiceWithInCorrectSignalClass() {
        String actualResponse = signalHandlerService.invokeTradeAlgorithm(AppConstants.SIGNAL_TWO);
